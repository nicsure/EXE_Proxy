This project is a tool to aid in debugging GUI front-ends for console applications. The compiled .exe from this project replaces the console level exe being called by the GUI front-end and the original exe is renamed appending _orig to the filename (without extension)
